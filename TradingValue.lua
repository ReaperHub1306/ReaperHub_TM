...
-- 2. Bảng Giá Trị (Value Table) - Đã cập nhật mới nhất
local ValueTable = {
    -- SS+ Tier
    ["bob cup"] = 70000,
    ...
    ["trollge mlg"] = 780,
    ["meme cup"] = 770,
    ["lord of darkness"] = 750,
    ["meme troll:???"] = 685,
    ["meme troll + evil skin"] = 675,
    ["meme troll"] = 675,
    ["cursed arrow"] = 660,
    ["hollow trolling:suppressed"] = 645,
    ["hollow trolling suppressed"] = 645,
    ["tanglecleaver"] = 615,
    ["shadow blade"] = 600,
    ["phantom feddy"] = 600,
    ["valentines chest"] = 600,
    ["the tiantui star"] = 575,
    ["the voices"] = 542,
    ["the roaring knight"] = 520,
